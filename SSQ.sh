...
do
    ...
    then
        ...
        then
            ...
            $PSCPDIR/pscp -l iwgroup -pw 'password' $BAKFILE/$NUMBFILENAME $IVR3:$IVRSERVERDIR/SSQ/$NUMBFILENAME >> $SCRIPTDIR/logs.txt 2>&1
            $PSCPDIR/pscp -l iwgroup -pw 'password' $BAKFILE/$NUMBFILENAME $IVR4:$IVRSERVERDIR/SSQ/$NUMBFILENAME >> $SCRIPTDIR/logs.txt 2>&1
            $PSCPDIR/pscp -l iwgroup -pw 'password' $BAKFILE/$NUMBFILENAME $IVR5:$IVRSERVERDIR/SSQ/$NUMBFILENAME >> $SCRIPTDIR/logs.txt 2>&1
            $PSCPDIR/pscp -l iwgroup -pw 'password' $BAKFILE/$NUMBFILENAME $IVR6:$IVRSERVERDIR/SSQ/$NUMBFILENAME >> $SCRIPTDIR/logs.txt 2>&1
            echo "now start transfer current issue file to IVR,time is `date +"%Y-%m-%d_%H:%M:%S"`..." >> $SCRIPTDIR/logs.txt
            $PSCPDIR/pscp -l iwgroup -pw 'password' $BAKFILE/SSQ.txt $IVR3:$IVRSERVERDIR/CurrentIssue/SSQ.txt >> $SCRIPTDIR/logs.txt 2>&1
            $PSCPDIR/pscp -l iwgroup -pw 'password' $BAKFILE/SSQ.txt $IVR4:$IVRSERVERDIR/CurrentIssue/SSQ.txt >> $SCRIPTDIR/logs.txt 2>&1
            $PSCPDIR/pscp -l iwgroup -pw 'password' $BAKFILE/SSQ.txt $IVR5:$IVRSERVERDIR/CurrentIssue/SSQ.txt >> $SCRIPTDIR/logs.txt 2>&1
            $PSCPDIR/pscp -l iwgroup -pw 'password' $BAKFILE/SSQ.txt $IVR6:$IVRSERVERDIR/CurrentIssue/SSQ.txt >> $SCRIPTDIR/logs.txt 2>&1
        fi
...
#                fi
                ...
                $PSCPDIR/pscp -l iwgroup -pw 'password' $BAKFILE/$BULLFILENAME $IVR3:$IVRSERVERDIR/SSQ/$BULLFILENAME >> $SCRIPTDIR/logs.txt 2>&1
                $PSCPDIR/pscp -l iwgroup -pw 'password' $BAKFILE/$BULLFILENAME $IVR4:$IVRSERVERDIR/SSQ/$BULLFILENAME >> $SCRIPTDIR/logs.txt 2>&1
                $PSCPDIR/pscp -l iwgroup -pw 'password' $BAKFILE/$BULLFILENAME $IVR5:$IVRSERVERDIR/SSQ/$BULLFILENAME >> $SCRIPTDIR/logs.txt 2>&1
                $PSCPDIR/pscp -l iwgroup -pw 'password' $BAKFILE/$BULLFILENAME $IVR6:$IVRSERVERDIR/SSQ/$BULLFILENAME >> $SCRIPTDIR/logs.txt 2>&1
            fi
        fi
    fi
done
