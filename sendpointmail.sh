#!/bin/sh
SCRIPTDIR="/home/iwgroup/pointmail"
...
pscp -p -l iwgroup -pw 'qX9&L1$l' iwgroup@192.168.61.2:/opt/iwgroup/vasoss/point-calculate-server/downtemp/${YESTERDAY}/*  ./$YESTERDAY >> $SCRIPTDIR/logs.log
