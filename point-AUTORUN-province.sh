...
SCRIPTDIR="/opt/iwgoup/vasoss/point-calculate-server-province/bin"
DOWNTEMP="/opt/iwgoup/vasoss/point-calculate-server/downtemp"
DATADIR="/opt/iwgoup/vasoss/point-calculate-server-province/data_province"
